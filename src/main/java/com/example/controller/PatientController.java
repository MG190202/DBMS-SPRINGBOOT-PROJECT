...
public class PatientController {
    ...
    @GetMapping("/show-history/{name}/{r}/{d}")
    public String doctorDetails(Model model,@PathVariable("name")String name,@PathVariable("r")Integer r,@PathVariable("d")Integer d){
